...
namespace POFtpSender
{
    static class Program
    {
        ...
        // key => connection id
        public static void ConnectMonitorHub(string url, string key)
        {
            string[] arrUrl = url.Split(':');
            //TODO UPDATE
            string signalRpath = string.Concat(arrUrl[0] + ":", arrUrl[1], ":8885");
            //string signalRpath = string.Concat(arrUrl[0] + ":", "//10.21.31.177", ":8885");
        ...
        {
            //MessageBox.Show("addMessage : " + message);
            ClassHelper.QueueMessage.Enqueue(message);
        }
        ...
        private static void HubConnection_StateChanged(StateChange obj)
        {
            ...
            ClassHelper.HubStatusConnection = obj.NewState;
        }
    }
}
