...
namespace POProject.API.Module
{
    public class UpdateModule : NancyModule
    {
        ...
        public UpdateModule()
        {
            ...
            Get["/download/getLatestVersion"] = parameter =>
            {
                ...
                return Response.AsJson(new { code = HttpStatusCode.OK, message = "Ok", body = latestVers.FirstOrDefault().version });
            };

            Post["download/update"] = parameter =>
            {
