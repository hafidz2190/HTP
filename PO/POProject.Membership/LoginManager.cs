...
namespace POProject.Membership
{
    public class LoginManager
    {
        ...
        public bool Login(string usernameapp, string username, string password)
        {
            bool result = false;
            MembershipUser user;
            ...
            if (user != null)
            {
                string usernm = $"'{usernameapp}'";
                UserClient userClient = BusinessLogic.SettingClientBusiness.RetrieveUserClient(usernm).FirstOrDefault();
