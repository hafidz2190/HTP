...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
    ...
    notblank: "Data Tidak Boleh Kosong.",
    required: "Data TTidak Boleh Kosong",
    pattern: "Isi Tidak Valid",
    min: "Isi Tidak Boleh Lebih Kecil Dari %s.",
    max: "Isi Harus Lebih Kecil dari %s.",
    range: "Range harus diantara %s dan %s.",
    minlength: "Panjang minimum character %s.",
    maxlength: "Panjang Maksimum character %.",
    length: "Panjang Tidak Valid. Panjang character Harus antara %s dan %s .",
    mincheck: "You must select at least %s choices.",
    maxcheck: "You must select %s choices or less.",
    check: "You must select between %s and %s choices.",
    equalto: "Isi harus sama dengan."
});
